...
import { Sparkles, Link as LinkIcon, Plus, ArrowRight, Zap, Compass } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto py-12 px-4 fade-in-up">
      <div className="text-center space-y-4 mb-12">
        ...
        <h2 className="text-4xl font-bold text-white tracking-tighter leading-tight">
          Unlock your Match Score in <span className="text-[#FC6100]">30 seconds.</span>
        </h2>
        <p className="text-gray-400 text-sm max-w-xl mx-auto font-medium">
          Your pipeline is empty. Compare your resume against a target job posting to see your ATS Match Score and skills gap.
        </p>
      </div>

      <div className="flex flex-col gap-6">
        {/* Dominant Path: Compare Job Link */}
        <button
          ...
          <div className="flex items-center gap-8 relative z-10">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3 flex-wrap">
                <h3 className="text-2xl font-bold text-white tracking-tight">Compare Job Link</h3>
                <div className="flex gap-1.5">
                  ...
                  <span className="px-2 py-0.5 rounded bg-amber-500/10 text-amber-400 border border-amber-500/20 text-[8px] font-black uppercase tracking-wider">Company Sites</span>
              ...
              <p className="text-xs text-gray-400 leading-relaxed font-medium max-w-sm">
                Paste any job posting URL to analyze and calculate your compatibility score in real-time.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Path 1: Discover Matches */}
          <button
            onClick={() => {
              trackEvent('onboarding_discover_matches_clicked');
              navigate('/discovery');
            }}
            data-testid="onboarding-discover-btn"
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-white tracking-tight">Discover Matches</h3>
              <p className="text-[10px] text-gray-500 font-medium">Scan the market for roles matching your skills.</p>
            </div>
